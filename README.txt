...
Katalogen ska då ligga under "Dokument/EdvinsProject/ProductData". Katalogen innehåller 4 filer där man kan fylla på med data.
...
I mitt programm så kan du välja hur du vill spara produkterna. Det finns 2 val, JSON eller CSV fast istället för komma-tecken eller liknande så är avskiljaren #.
Du kan välja på vilket sätt som du sparar på, i programmet under inställningarna. Standard är CSV.
Dessa filer sparas i dokument under namnet: EdvinsProject
